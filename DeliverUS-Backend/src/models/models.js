...
const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, Performance, User }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, Performance, User, sequelizeSession }
