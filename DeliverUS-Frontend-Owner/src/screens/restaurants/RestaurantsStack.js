...
import CreateRestaurantsCategoryScreen from './CreateRestaurantsCategoryScreen'
    ...
    <Stack.Navigator>
      <Stack.Screen
        ...
        options={{
         ...
         <Stack.Screen
        name='CreateRestaurantsCategoryScreen'
        component={CreateRestaurantsCategoryScreen}
        options={{
